          ...
          <SafeAreaView style={styles.container}>
            ...
            <View style={styles.content}>
              ...
              <View style={styles.authToggle}>
                ...
                >
                  <Link href={"/(auth)/signup"} style={styles.toggleButtonText}>SIGN UP</Link>
                </TouchableOpacity>
              </View>
              ...
              {/* Login Button */}
              <Animated.View style={[styles.accessButton, { transform: [{ scale: buttonScale }] }]}>
                <TouchableOpacity
                  onPress={handleLogin}
                ...
                >
                  <Text style={styles.accessButtonText}>ACCESS CONTROL GRID</Text>
